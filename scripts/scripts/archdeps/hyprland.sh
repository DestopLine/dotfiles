...
yay -S --needed git hyprland hyprpaper hyprlock hyprpolkitagent xdg-desktop-portal-hyprland waybar\
	ttf-jetbrains-mono-nerd kitty rofi-wayland rofi-calc grim slurp swappy copyq dmenu wl-clipboard\
	network-manager-applet noto-fonts noto-fonts-emoji noto-fonts-cjk numix-cursor-theme adwaita-dark\
	lxappearance alsa-utils pipewire pulseaudio wireplumber python pavucontrol blueman polkit qt5ct udiskie
